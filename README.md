...
The [Proposed Selections section](https://therealjameswilson.github.io/Bush41-Foreign-Economic-Policy/#frus-selections) contains **37 proposed documents and four supporting memoranda for annotation**, 34 to or from Brent Scowcroft. The latest 30 document proposals focus on international financial institutions: IMF quotas and concessional lending, World Bank and IDA resources, development-bank voting, EBRD rules, and coordination of development finance. This selective set spans January 1989–March 1992 and 16 official file-unit PDFs; it does not claim complete coverage of the administration or any collection.
