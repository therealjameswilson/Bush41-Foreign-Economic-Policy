...
The collection workbench currently includes ten complete Catalog collections or series:
...
The checked-in site is static. To refresh the ten archival collection tabs from NARA, then rebuild the generated data from the collection files and adjacent Western Europe presidential-conversation register:
